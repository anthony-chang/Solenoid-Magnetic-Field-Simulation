# Solenoid-Magnetic-Field-Simulation
 ...
 [One of the simulations](simulation.m) show the interactions of the B lines, and [the other simulation](simulationHeatmap.m) shows a heatmap of the magnitudes of the B field. The output can be viewed [here.](output.pdf)
